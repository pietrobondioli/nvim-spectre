...
local additional_fixtures = {
    {
        name = 'case 9 (show_replace true, show_search false)',
        search_query = '(\\w)-(\\w)',
        replace_query = '\\1", "\\2',
        search_text = '["tigre-dentes-sabre"]',
        show_replace = true,
        show_search = false,
        replace_text = '["tigre", "dentes", "sabre"]',
        result = { search = {}, replace = { { 7, 12 }, { 17, 22 } } },
    },
    {
        name = 'case 10 (show_replace true, show_search true)',
        search_query = '(\\w)-(\\w)',
        replace_query = '\\1", "\\2',
        search_text = '["tigre-dentes-sabre"]',
        show_replace = true,
        show_search = true,
        replace_text = '["tigre-de", "dentes-ss", "sabre"]',
        result = { search = { { 7, 9 }, { 20, 22 } }, replace = { { 10, 15 }, { 23, 28 } } },
    },
}

describe('utils test different highlight', function()
    local regex = require('spectre.regex.vim')
    -- Add additional fixtures to the test cases
    for _, value in pairs(additional_fixtures) do
